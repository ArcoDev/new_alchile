  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Administración interno del sitio web de Alchile Studio</h3>
      </div>
      <center>
      <img src="../../src/icons/alchile.svg" alt="Logo alchile studio" width="500" heigth="500">
      <div class="box-body">
